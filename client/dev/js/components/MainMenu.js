...
import { LANGUAGE, LETSGO } from '../constants';
    ...
    return (
      <Fragment>
        ...
        <div className="main-menu">
          <div className="cards-types-header">
            <span>WORD TYPES</span>
          </div>
          <div className="cards-types-options">
            <div
              className={
                !wordType.includes("verb") ? "verb-opt" : "verb-opt active"
              }
            ...
            <div
              className={
                !wordType.includes("noun") ? "noun-opt" : "noun-opt active"
              }
            ...
            <div
              className={
                !wordType.includes("adj") ? "adj-opt" : "adj-opt active"
              }
          ...
          <div className="cards-focus-header">
            <span>STUDY FOCUS</span>
          </div>
          <div className="cards-focus-options">
            <div
              className={focussed == "all" ? "all-opt active" : "all-opt"}
            ...
            <div
              className={
                focussed == "focussed" ? "focus-opt active" : "focus-opt"
              }
          ...
          <div className="cards-front-header">
            <span>FRONT FACE LANGUAGE</span>
          </div>
          <div className="cards-front-options">
            <div
              className={
                frontFace == "french" ? "french-opt active" : "french-opt"
              }
            ...
            <div
              className={frontFace == "both" ? "both-opt active" : "both-opt"}
            ...
            <div
              className={
                frontFace == "english" ? "english-opt active" : "english-opt"
              }
          ...
          <div className="cards-limit-header">
            <span>TOTAL CARDS LIMIT</span>
          </div>
          <div className="cards-limit-options">
            <div
              className={limit === 10 ? "opt-10 active" : "opt-10"}
              onClick={() =>
                limit !== 10
            ...
            <div
              className={limit === 25 ? "opt-25 active" : "opt-25"}
              onClick={() => this.setState({ limit: 25 })}
            >
              <span>25</span>
            </div>
            <div
              className={limit === 50 ? "opt-50 active" : "opt-50"}
              onClick={() => this.setState({ limit: 50 })}
            >
              <span>50</span>
            </div>
            <div
              className={limit === 100 ? "opt-100 active" : "opt-100"}
          ...
          <div className="confirm-options">
            <button onClick={() => this.setState({ onyva: true })}>
              {LETSGO}
            </button>
          </div>
        </div>
